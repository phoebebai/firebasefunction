...
const server = app.listen(8081, function () {
    ...
    console.log("The server is hosting on http://127.0.0.1:%s", port)
});
 */
...
exports.test = functions.https.onRequest((request, response) => {
    ...
    var mountainsRef = storageRef.child('/test.jpg');
    let file = fs.readFile("G:\\NodeJsProject\\firebasehosting\\functions\\image\\test.jpg", () => {});
